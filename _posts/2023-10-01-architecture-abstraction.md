...
Well. Continuing to write backend for volunteer project, logic is getting more complex.
...
Option 2 is simpler, but I don't like it. First, because come on, I can do better. Second moment is that the project is potentially growing and in the future, if everything goes as well, we'll need to expand. Which means there will definitely be problems. If I was writing a project that no one needs and won't grow, you could stop at the moment "don't start writing code" or "thanks, I'll decline participation in your project".
